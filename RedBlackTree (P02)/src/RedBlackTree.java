...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
  ...
  private boolean insertHelper(Node<T> newNode, Node<T> subtree) {
    ...
    // store newNode within left subtree of subtree
      ...
      if (subtree.leftChild == null) { // left subtree empty, add here
        ...
        enforceRBTreeProperties(newNode);
        return true;
  ...
  private void enforceRBTreeProperties(Node<T> n) {
    if (n != null && n.parent != null) {
      if (n.isLeftChild()) {
        if (n.parent.isBlack == false) {
          // Red Parent, Black/Null Sibling, Parent and Child Nodes are the same side (LL)
          if (n.parent.isLeftChild() && (n.parent.parent.rightChild == null
              || n.parent.parent.rightChild.isBlack == true)) {
            rotate(n.parent, n.parent.parent);
            n.parent.isBlack = true;
            n.parent.rightChild.isBlack = false;
          }
          // R Parent, B/N Sibling, Parent and Child Nodes are different sides (LR)
          else if (!
              n.parent.isLeftChild()
              && (n.parent.parent.leftChild == null || n.parent.parent.leftChild.isBlack == true)) {
            rotate(n,n.parent);
            rotate(n,n.parent);
            n.isBlack=true;
          ...
          // R Parent, R Sibling
          else if(n.parent.parent.leftChild.isBlack==false) {
            n.parent.parent.isBlack=false;
            n.parent.parent.leftChild.isBlack=true;
            n.parent.parent.rightChild.isBlack=true;
            enforceRBTreeProperties(n.parent.parent);
          }
        }
      }
      else if(!n.isLeftChild()) {
        if (n.parent.isBlack == false) {
          // Red Parent, Black/Null Sibling, Parent and Child Nodes are the same side (RR)
          if (!n.parent.isLeftChild() && (n.parent.parent.leftChild == null
              || n.parent.parent.leftChild.isBlack == true)) {
            rotate(n.parent, n.parent.parent);
            n.parent.isBlack = true;
          ...
          // R Parent, B/N Sibling, Parent and Child Nodes are different sides (LR)
              ...
              n.parent.isLeftChild()
              && (n.parent.parent.rightChild == null || n.parent.parent.rightChild.isBlack == true)) {
            rotate(n,n.parent);
            rotate(n,n.parent);
            n.isBlack=true;
          ...
          // R Parent, R Sibling
          else if(n.parent.parent.rightChild.isBlack==false) {
            n.parent.parent.isBlack=false;
            n.parent.parent.leftChild.isBlack=true;
            n.parent.parent.rightChild.isBlack=true;
            enforceRBTreeProperties(n.parent.parent);
